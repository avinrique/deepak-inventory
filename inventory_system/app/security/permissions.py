...
PERMISSIONS: list[PermissionDef] = [
    ...
    PermissionDef("sales.read", "View sales orders"),
...
_OPERATIONAL = [
    ...
    "sales.create", "sales.read", "sales.update", "sales.confirm", "sales.fulfill",
...
ROLE_PERMISSIONS: dict[str, list[str]] = {
    ...
    "SALES_STAFF": [*_PRODUCT_READ_ONLY, "sales.create", "sales.update", "sales.read",
    ...
    "ACCOUNTANT": [
        ...
        "sales.read", "sales.payment", "sales.refund",
